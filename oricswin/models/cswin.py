...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=96, depth=[2,2,6,2], split_size = [3,5,7],
        ...
        heads=num_heads
        self.s11=nn.Conv2d(in_chans, embed_dim, 8, 4, 2)
        self.s12=Rearrange('b c h w -> b (h w) c', h = img_size//4, w = img_size//4)
        self.s13=nn.LayerNorm(embed_dim)
        # self.stage1_conv_embed = nn.Sequential(
        #     nn.Conv2d(in_chans, embed_dim, 8, 4, 2),
